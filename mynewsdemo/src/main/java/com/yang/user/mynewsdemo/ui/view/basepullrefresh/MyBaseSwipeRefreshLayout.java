package com.yang.user.mynewsdemo.ui.view.basepullrefresh;
...
/**
 * The MyBaseSwipeRefreshLayout should be used whenever the user can refresh the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The MyBaseSwipeRefreshLayout
 ...
 * width and the height supplied in this layout. The MyBaseSwipeRefreshLayout does not
 * provide accessibility events; instead, a menu item must be provided to allow
 * refresh of the content wherever this gesture is used.
 * </p>
 */
public class MyBaseSwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = MyBaseSwipeRefreshLayout.class.getSimpleName();
    ...
    /**
     * Simple constructor to use when creating a MyBaseSwipeRefreshLayout from code.
     *
     * @param context
     */
    public MyBaseSwipeRefreshLayout(Context context) {
        this(context, null);
    }

    /**
     * Constructor that is called when inflating MyBaseSwipeRefreshLayout from XML.
     *
     * @param context
     * @param attrs
     */
    public MyBaseSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//                     (width / 2 + circleWidth / 2), childHeight/2 + circleHeight);
    ...
    /**
     * Set a callback to override {@link MyBaseSwipeRefreshLayout#canChildScrollUp()} method. Non-null
    ...
    /**
     * Classes that wish to override {@link MyBaseSwipeRefreshLayout#canChildScrollUp()} method
     * behavior should implement this interface.
     */
    public interface OnChildScrollUpCallback {
        /**
         * Callback that will be called when {@link MyBaseSwipeRefreshLayout#canChildScrollUp()} method
         * is called to allow the implementer to override its behavior.
         *
         * @param parent MyBaseSwipeRefreshLayout that this callback is overriding.
         * @param child  The child view of MyBaseSwipeRefreshLayout.
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(MyBaseSwipeRefreshLayout parent, @Nullable View child);
    }
}
