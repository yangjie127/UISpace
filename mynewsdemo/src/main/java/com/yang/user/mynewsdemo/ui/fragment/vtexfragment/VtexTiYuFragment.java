...
public class VtexTiYuFragment extends MyBaseFragment {
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("tiyu", Constants.TIANXING_KEY, pagerNumberContent, currentpage);
