...
public class VtexMeiNvFragment extends MyBaseFragment {
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("meinv", Constants.TIANXING_KEY, pagerNumberContent, currentpage);
