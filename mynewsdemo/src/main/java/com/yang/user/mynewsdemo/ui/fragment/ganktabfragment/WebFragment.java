...
import com.yang.user.mynewsdemo.ui.adapter.GankWebAdapter;
...
public class WebFragment extends Fragment {
    ...
    private GankWebAdapter adapter;
    ...
    private static final int pagerNumberContent = 10;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        layoutInflater = LayoutInflater.from(getActivity());
        view = layoutInflater.inflate(R.layout.ganktabfragment_web, container, false);
...
//                    Toast.makeText(getContext(), "" + mList.size() + "---" + currentpage, Toast.LENGTH_SHORT).show();
    ...
    private void initData() {
        ...
        Call<GankTechHttpBean> gankTechHttpBeanCall = gankApis.getGankTechList("前端", pagerNumberContent, currentpage);
        gankTechHttpBeanCall.enqueue(new Callback<GankTechHttpBean>() {
            ...
            public void onResponse(Call<GankTechHttpBean> call, Response<GankTechHttpBean> response) {
                ...
                adapter = new GankWebAdapter(getActivity(), mList);
