...
public class VtexGuoneiFragment extends MyBaseFragment {
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("guonei", Constants.TIANXING_KEY, pagerNumberContent, currentpage);
