...
public class VtexQiwenFragment extends MyBaseFragment {
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("qiwen", Constants.TIANXING_KEY, pagerNumberContent, currentpage);
