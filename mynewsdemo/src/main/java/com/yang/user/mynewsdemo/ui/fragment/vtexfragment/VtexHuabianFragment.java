...
public class VtexHuabianFragment extends MyBaseFragment{
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("huabian", Constants.TIANXING_KEY,pagerNumberContent, currentpage);
