...
public class VtexWorldFragment extends MyBaseFragment {
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("world", Constants.TIANXING_KEY, pagerNumberContent, currentpage);
