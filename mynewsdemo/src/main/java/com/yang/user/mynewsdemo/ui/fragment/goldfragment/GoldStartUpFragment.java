...
import com.yang.user.mynewsdemo.ui.adapter.goldadapter.GoldStartUpAdapter;
...
public class GoldStartUpFragment extends MyBaseFragment {
    ...
    GoldStartUpAdapter adapter;
    List<GoldStartUpBean.NewslistBean> mList = new ArrayList<>();
    ...
    protected void initData() {
        ...
        Call<GoldStartUpBean> goldITBeanCall = goldApis.getGoldStartUpBean("startup", Constants.TIANXING_KEY, pagerNumberContent, currentpage);

        goldITBeanCall.enqueue(new Callback<GoldStartUpBean>() {
            @Override
            public void onResponse(Call<GoldStartUpBean> call, Response<GoldStartUpBean> response) {
//                mList = response.body().getNewslist();
                mList.addAll(response.body().getNewslist());
                adapter = new GoldStartUpAdapter(mContext, mList);
                recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();

                adapter.setOnItemClickListener(new GoldStartUpAdapter.OnItemClickListener() {
                    @Override
            ...
            @Override
            public void onFailure(Call<GoldStartUpBean> call, Throwable t) {
