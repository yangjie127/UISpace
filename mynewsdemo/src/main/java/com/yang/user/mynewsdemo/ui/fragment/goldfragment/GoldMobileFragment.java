...
import com.yang.user.mynewsdemo.ui.adapter.goldadapter.GoldMobileAdapter;
...
public class GoldMobileFragment extends MyBaseFragment {
    ...
    GoldMobileAdapter adapter;
    List<GoldMobileBean.NewslistBean> mList = new ArrayList<>();
    ...
    protected void initData() {
        ...
        Call<GoldMobileBean> goldITBeanCall = goldApis.getGoldMobileBean("mobile", Constants.TIANXING_KEY, pagerNumberContent, currentpage);

        goldITBeanCall.enqueue(new Callback<GoldMobileBean>() {
            @Override
            public void onResponse(Call<GoldMobileBean> call, Response<GoldMobileBean> response) {
//                mList = response.body().getNewslist();
                mList.addAll(response.body().getNewslist());
                adapter = new GoldMobileAdapter(mContext, mList);
                recyclerView.setAdapter(adapter);
                adapter.notifyDataSetChanged();

                adapter.setOnItemClickListener(new GoldMobileAdapter.OnItemClickListener() {
                    @Override
            ...
            @Override
            public void onFailure(Call<GoldMobileBean> call, Throwable t) {
