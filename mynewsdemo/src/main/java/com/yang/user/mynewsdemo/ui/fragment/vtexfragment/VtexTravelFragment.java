...
public class VtexTravelFragment extends MyBaseFragment {
    ...
    protected void initData() {
        ...
        Call<GoldAppleBean> goldITBeanCall = goldApis.getGoldAppleBean("travel", Constants.TIANXING_KEY, pagerNumberContent, currentpage);
